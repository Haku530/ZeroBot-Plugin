...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:5141/onebot", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "魔理沙", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	sus = append(sus, 1501673949)
	sus = append(sus, 2063634394)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "魔理沙", "沙沙"),
